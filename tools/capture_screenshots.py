...
def main():
    ...
    try:
        ...
        call("::analog_lens::check_environment")
        call("wm", "geometry", WINDOW + ".environment", "760x560+40+40")
        capture("environment-check.png", WINDOW + ".environment")
        call("destroy", WINDOW + ".environment")
