...
Version: 0.5.0 · Target: IIC-OSIC-TOOLS, Linux/X11 · Date: 2026-09-22

## Native verification

**104 tests pass** with Python 3.12 and Tcl/Tk 8.6.14 on Linux under Xvfb, without skips. The native Tk widget/event smoke test also passes.
...
Validated with **IIC-OSIC-TOOLS 2026.08** in [integration run 35756609167](https://github.com/jonahsaunders/analog-lens/actions/runs/35756609167), using code commit [`09c9cec`](https://github.com/jonahsaunders/analog-lens/commit/09c9cec27dd97a263b7e0ae2ede7118de88bad61).
...
- 104 native/contract tests passed in the container, without skips.
...
The [machine-readable v0.5 summary](docs/validation/iic-2026.08-v0.5.json) records versions, measured errors, deck hashes, geometry checks, verification verdicts and batch reuse. The workflow artifact retains generated schematics/decks, raw files, exports, dependency manifests, screenshots and logs. PDK model files are not redistributed. The [v0.4 summary](docs/validation/iic-2026.08-v0.4.json) remains available as historical evidence.
